...
var IconText_excluded = ["children", "className", "color", "component"];
...
function IconText(_ref) {
  ...
  var classes = classnames_default()('icon-text', className, isColor);
  return /*#__PURE__*/external_react_default.a.createElement(Element, IconText_extends({
    className: classes
  }, props), children);
}
IconText.propTypes = {
...
// CONCATENATED MODULE: ./src/0.9.2.js
// Elements
